...
export const cricketData: StaticPageData = {
  ...
  hero: {
    titleWords: [
      ...
      { text: " Cricket for <br/>Every Player. Every Day.", color: "#FFFFFF" },
    ],
  ...
  cardSection5: {
    ...
    cardSection: [
      ...
      },
      {
        ...
        iconImage:
          "https://da8nru77lsio9.cloudfront.net/images/cricket/cricket-icon-2.svg",
        link: "",
      },
      {
        title: "Premium Turf",
      ...
      },
      {
        ...
        iconImage:
          "https://da8nru77lsio9.cloudfront.net/images/cricket/cricket-icon-4.svg",
        link: "",
      },
      {
