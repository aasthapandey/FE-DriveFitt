...
export const franchiseData: FranchisePageData = {
  ...
  hero: {
    ...
    desktopImage:
      "https://da8nru77lsio9.cloudfront.net/images/franchise/hero.svg",
    mobileImage:
      "https://da8nru77lsio9.cloudfront.net/images/franchise/mobile-hero.svg",
  ...
  multiRevenueSection: {
    ...
    cardList: [
      ...
      },
      {
        ...
        title: "Retail & Café",
        description:
          "Sports equipment, supplements, accessories, apparel, and healthy meal options",
      },
      {
  ...
  opportunitySection: {
    ...
    cardList: [
      ...
      {
        icon: "https://da8nru77lsio9.cloudfront.net/images/franchise/payback-icon.svg",
        title: "Payback",
        subTitle: "2.5 years",
        description: "Quick capital recovery",
      },
      {
        icon: "https://da8nru77lsio9.cloudfront.net/images/franchise/capex-icon.svg",
  ...
  whatLookingForSection: {
    ...
    cardList: [
      ...
      {
        icon: "https://da8nru77lsio9.cloudfront.net/images/franchise/investment-capacity-icon.svg",
        title: "Investment Capacity",
        description: "₹8–10 Cr+ investment capacity with financial stability",
      },
      {
      ...
      {
        icon: "https://da8nru77lsio9.cloudfront.net/images/franchise/values.svg",
        title: "Shared Values",
        description:
  ...
  nextStepSection: {
    ...
    cardList: [
      ...
      {
        icon: "https://da8nru77lsio9.cloudfront.net/images/franchise/launch-icon.svg",
        title: "Launch & Grow",
        description:
