  ...
  return (
    <section className="md:px-[120px] px-6 flex justify-center md:-my-[120px]">
      <button
        ...
        className="bg-[#00DBDC] border border-transparent rounded-lg px-10 py-3 text-[#0D0D0D] font-medium text-base hover:bg-transparent hover:border-[#00DBDC] hover:text-[#00DBDC] transition-all duration-200 md:px-[48px] md:h-[50px]"
      >
        Join Now
      </button>
