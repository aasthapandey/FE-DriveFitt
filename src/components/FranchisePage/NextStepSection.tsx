        ...
        <div className="relative flex flex-col justify-around items-center">
          ...
          {cardList.map((card, index) => {
            return (
              <div
                key={card.title}
                className="relative bg-[#333333] size-[48px] md:size-[100px] rounded-full flex justify-center items-center text-2xl md:text-5xl leading-[100%] md:leading-[56px] font-light"
              >
                {index + 1}
              </div>
            );
